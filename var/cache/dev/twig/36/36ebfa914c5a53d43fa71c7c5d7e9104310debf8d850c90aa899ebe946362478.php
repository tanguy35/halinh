...
/* main/list.html.twig */
class __TwigTemplate_6180b712e8521aed7ddb22a63c7758964f7eb712726cb7c849f22c0aaf1468c5 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        <div id=\"apropos\" class=\"row  text-center \" >

            <p data-aos=\"fade-right\" data-aos-duration=\"2000\">Bienvenue</p>
            <h1 data-aos=\"fade-left\" data-aos-duration=\"3000\">L'HEURE DE BEAUTE</h1>
            <h2 data-aos=\"fade-right\" data-aos-duration=\"2000\">salon d'esthetique de Rennes</h2>
    ...
    <div class=\"container-fluid\">
        ...
        <section class=\"row col-12  align-items-center justify-content-center\" id=\"positionColonne\">
            ...
            <div class=\"cadre\"></div>
            <div class=\"col-md-4 image\" data-aos=\"zoom-in\" data-aos-duration=\"3000\">
                <img src=\"";
        // line 25
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("img/pexels-photo-8558549.jpeg"), "html", null, true);
        ...
        <section class=\"row col-12\" id=\"menu\">
            ...
            <div class=\"col-md-2 aside1\" ></div> <!--ASIDE GAUCHE-->
            ...
            <div class=\"col-12 col-md-8 \">
                ...
                <table class=\"table\">
                    <thead>
                    <th><h3>Beauté des mains, des pieds</h3></th>
                    <th>prix</th>
                    </thead>
                    <tbody>
                    <tr>
                ...
                <table class=\"table\">
                    <thead>
                    <th><h3>Maquillage semi-permanent</h3></th>
                    <th>prix</th>
                    </thead>
                    <tbody>
                    <tr>
            ...
            <div class=\"col-md-2 aside2\"></div> <!--ASIDE DROITE-->
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["articles"]) || array_key_exists("articles", $context) ? $context["articles"] : (function () { throw new RuntimeError('Variable "articles" does not exist.', 158, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["article"]) {
            ...
            echo "
                <div class=\"col-md-4 mt-5 text-center\">
                    ...
                    <div class=\"card animediv\" >
                        ...
                        <img id=\"animate\" src=\"";
            // line 164
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl(("img/" . twig_get_attribute($this->env, $this->source, $context["article"], "poster", [], "any", false, false, false, 164))), "html", null, true);
            echo "\" alt=\"";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["article"], "titre", [], "any", false, false, false, 164), "html", null, true);
            echo "\" class=\"card-img-top\">
                        ...
                        <div class=\"card-body\">
                            ...
                            <h5 class=\"card-title\">";
            // line 168
            echo twig_escape_filter($this->env, twig_capitalize_string_filter($this->env, twig_get_attribute($this->env, $this->source, $context["article"], "titre", [], "any", false, false, false, 168)), "html", null, true);
            echo "</h5>

                            <p class=\"card-text\">";
            // line 170
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $this->extensions['Twig\Extra\String\StringExtension']->createUnicodeString(twig_get_attribute($this->env, $this->source, $context["article"], "content", [], "any", false, false, false, 170)), "truncate", [0 => 100, 1 => "..."], "method", false, false, false, 170), "html", null, true);
            echo "</p>

                            <a href=\"";
            // line 172
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("detail", ["id" => twig_get_attribute($this->env, $this->source, $context["article"], "id", [], "any", false, false, false, 172)]), "html", null, true);
...
";
    ...
    {
        return array (  287 => 181,  272 => 172,  267 => 170,  262 => 168,  253 => 164,  246 => 159,  242 => 158,  106 => 25,  87 => 8,  77 => 7,  59 => 5,  36 => 1,);
    }
...
{% block body %}
    ...
    <div class=\"container-fluid\">
        ...
        <section class=\"row col-12  align-items-center justify-content-center\" id=\"positionColonne\">
            ...
            <div class=\"cadre\"></div>
            <div class=\"col-md-4 image\" data-aos=\"zoom-in\" data-aos-duration=\"3000\">
                <img src=\"{{ asset(\"img/pexels-photo-8558549.jpeg\") }}\" alt=\"photo maquillage\">
            </div>
            ...
            {% for article in articles %}
                ...
                <div class=\"col-md-4 mt-5 text-center\">
                    ...
                    <div class=\"card animediv\" >
                        ...
                        <img id=\"animate\" src=\"{{asset(\"img/\"~article.poster)}}\" alt=\"{{ article.titre }}\" class=\"card-img-top\">
